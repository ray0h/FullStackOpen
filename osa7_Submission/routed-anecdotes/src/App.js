...
const Anecdote = ({ anecdotes }) => {
  ...
  return (
    <div>
      ...
      <h4>-{anecdote.author}, <a href={anecdote.info} target ='_blank' rel='noopener noreferrer'>for more info</a></h4>
    </div>
  )
}
  ...
  return (
    <div>
      ...
      <Router>
        ...
        <Switch>
          <Route path='/create-new'><CreateNew addNew={addNew}/></Route>
          <Route path='/about'><About/></Route>
          <Route path='/:id'><Anecdote anecdotes={anecdotes}/></Route>
